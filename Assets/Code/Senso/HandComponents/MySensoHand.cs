...
public class MySensoHand : SensoHand {
	...
	public void SetSensoPose (SensoHandData aData)
	{
		...
		//Fingers
		setFingerBones(ref thumbBones, ref aData.fingerAngles[0], ESensoFingerType.Thumb);
		setFingerBones(ref indexBones, ref aData.fingerAngles[1], ESensoFingerType.Index);
		setFingerBones(ref middleBones, ref aData.fingerAngles[2], ESensoFingerType.Middle);
		setFingerBones(ref thirdBones, ref aData.fingerAngles[3], ESensoFingerType.Third);
		setFingerBones(ref littleBones, ref aData.fingerAngles[4], ESensoFingerType.Little);
	}

	private static void setFingerBones(ref Transform[] bones, ref Vector3 angles, ESensoFingerType fingerType)
	{
